    ...
    <div class="col-md-12 grid-margin">
        <div class="row">
            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                ...
                <h6 class="font-weight-normal mb-0">Completa la información del nuevo cliente.</h6>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-10 col-xs-12 grid-margin stretch-card" >    
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">Registra la información completa del cliente.</p>

                <form id="formNuevoCliente" action="action/control_cliente.php" method="post"> 
                    ...
                    <div class="contenedor-boton">
                        <button type="submit" class="btn btn-sm btn-info">Registrar Cliente</button>
                    </div>
